...
#   - xhttp: transport delegated to the standalone sing-xhttp v0.1.5 library
#     (full Xray splithttp parity, REALITY/HTTP3/uTLS, per-mode defaults);
#     in-tree transport/v2rayxhttp is now a thin bridge. v0.1.5 completes the
...
export COMMIT_SING_BOX="9aec47cb6fe4c1878cec8d48921167c4882c1edb"
